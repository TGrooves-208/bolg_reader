...
//  blog_reader
//
//  Created by Gil Aguilar on 5/5/16.
//  Copyright © 2016 redeye-dev. All rights reserved.
//  Need to change the plist settings in order to allow the page from being blocked
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string:"https://www.googleapis.com/blogger/v3/blogs/2399953/posts?key=AIzaSyDvaDNgMssE_GNm2GVtzlu7PvGp4m8yLlE")!;
